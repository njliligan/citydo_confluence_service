...
public class RedisUtils {
     ...
     * @param key  键
     * @param obj  对象
     * @param type 0左边加入 1右边加入
     * @return
     */
    public Long lAdd(int type, String key, Object obj) {
        try {
            if (0 == type) {
     ...
     * @author Lee
     * @description 获取锁
     * @date 2020-05-12 10:04
     **/
    public boolean lockStock() {
        return this.lock("stock:order", 1, 30L);
    }
